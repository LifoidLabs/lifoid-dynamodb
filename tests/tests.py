...
import datetime
import time
from lifoid_dynamodb.repository import Repository
from lifoid_dynamodb.record import NamedtupleRecord
...
class DynamodbBackendTests(unittest.TestCase):
    """
    ...
    def test_singleton(self):
        ...
        """
        repo1 = MyRepository(DynamodbBackend, 'example')
        repo2 = MyRepository(DynamodbBackend, 'example')
    ...
    def test_save_record(self):
        ...
        """
        my_repository = MyRepository(DynamodbBackend, 'example')
